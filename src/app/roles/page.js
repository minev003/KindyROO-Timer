                    ...
                    <div className="card mb-3">
                                ...
                                <div
                                    ...
                                    <div id="table-simple-pagination-replace-element">
                                        ...
                                        <a style={{
                                           ...
                                           href="/roles/create" role="button">

                                                            <span
                                                                className="fas fa-plus"
                                                                data-fa-transform="shrink-3 down-2"></span><span
                                            className="d-none d-sm-inline-block ms-1">Create New Role</span>
                                        </a>
                        ...
                        <div className="card-body px-0 pt-1 pb-1">
                            ...
                            <table id="example987"
                                ...
                                <tr>
                                    <th className="sort">Roles</th>
                                    <th className="sort">Rights</th>
                                    <th className="sort text-end">Action</th>
                                </tr>
                                </thead>
                                <tbody>

                                {userdata2.map((roleInfo, idx) => {
                                    return (
                                        <tr key={roleInfo.role_name + '-' + idx}>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <a style={{
                                                           ...
                                                           href={`roles/view/${roleInfo.roles_slug}`}>View</a>
                                                        <a style={{
                                                            display: editUserButton ? "block" : "none"
                                                        }}
                                                           className="dropdown-item"
                                                           href={`roles/edit/${roleInfo.roles_slug}`}>Edit</a>
