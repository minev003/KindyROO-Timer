...
export default function UsersPage() {
    ...
    // Error, because of next Link, the script file is only loaded once
    ...
    useEffect(() => {
        ...
        async function fetchUsers3() {
            ...
            let resp = await fetch('/api/rights/');

            data = await resp.json();
            console.log('data ', data)
            // console.log('typeof data2 ', typeof data2[0]);
            setuserData(data);
        }
    ...
    if (session.data.user.role_id === 'admin' && userdata2.length > 0) {
        ...
        for (var p in userdata2) {

            if ((userdata2[p].rights_name).length) {

                for (let i = 0; i < (userdata2[p].rights_name).length; i++) {
                    // console.log('i ', i)
                    // console.log('(userdata2[p].rights_name) ', (userdata2[p].rights_name))

                    if (i !== ((userdata2[p].rights_name).length - 1)) {
                        (userdata2[p].rights_name)[i] = (userdata2[p].rights_name)[i] + ', ';
                    } else {
                        //
                    }
                ...
                userdata2[p].rights_name[0] = 'No rights yet!';
        ...
        console.log('new userdata2 ', userdata2)
                    ...
                    <div className="card mb-3">
                                ...
                                <div
                                    ...
                                    <div id="table-simple-pagination-replace-element">
                                        ...
                                        <a style={{
                                           ...
                                           href="/rights/create" role="button">

                                                            <span
                                                                className="fas fa-plus"
                                                                data-fa-transform="shrink-3 down-2"></span><span
                                            className="d-none d-sm-inline-block ms-1">Create New Right</span>
                                        </a>
                        ...
                        <div className="card-body px-0 pt-1 pb-1">
                            ...
                            <table id="example987"
                                ...
                                <tr>
                                    <th className="sort" style={{width: '100 px'}}>Rights</th>
                                    <th className="sort">Description</th>
                                    <th className="sort">Rules</th>
                                    <th className="sort text-end">Action</th>
                                </tr>
                                </thead>
                                <tbody>

                                {userdata.map((roleInfo, idx) => {
                                    return (
                                        <tr key={roleInfo.rights_name + '-' + idx}>
                                            <td>{roleInfo.rights_name}</td>
                                            <td>{roleInfo.rights_description}</td>
                                            <td>{roleInfo.rights_rules}</td>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <a style={{
                                                           ...
                                                           href={`rights/view/${roleInfo.rights_slug}`}>View</a>
                                                        <a style={{
                                                            display: editUserButton ? "block" : "none"
                                                        }}
                                                           className="dropdown-item"
                                                           href={`rights/edit/${roleInfo.rights_slug}`}>Edit</a>
